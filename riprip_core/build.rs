...
fn main() {
	...
	// Generate "bool" constants appropriate for the version of libcdio.
	let data = libcdio_bools();
...
/// # Libcdio Bools.
///
/// The bindings generated by the `libcdio-sys` crate will either use `u8` or
/// `bool` for boolean values depending on which version — `2.1` or `2.2`
/// respectively — of `libcdio` happens to be installed on the system.
///
...
const LIBCDIO_FALSE: u8 = 0;"
	...
	// Modern versions use proper bools.
	else {
		"/// # `libcdio` True.
