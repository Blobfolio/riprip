...
impl RipBuffer {
	...
	/// # Cache Bust.
	///
	/// See `CddaDriver::cache_bust` for the complete rant.
	...
	pub(crate) fn read_sector(&mut self, cdio: &CddaDriver, lsn: i32, opts: &RipOptions)
	...
	fn read_c2(&mut self, cdio: &CddaDriver, lsn: i32, opts: &RipOptions)
	-> Result<bool, RipRipError> {
	...
	fn read_subchannel(&mut self, cdio: &CddaDriver, lsn: i32)
	-> Result<(), RipRipError> {
