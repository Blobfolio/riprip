...
/// a single fixed buffer more efficiently than separate strings.
...
impl DriveVendorModel {
	...
	pub fn vendor(&self) -> &str {
		if self.0[0] == 0 { "" }
			...
			// Safety: the data is instantiated from valid &str slices, so will
			// be equally valid when reconverted.
